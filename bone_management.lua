...
--             -- local particleName = "blood_mist" ECLAT GROS FUMER
--             -- local particleName = "liquid_splash_blood" -- eclat de sang leger
--             -- local particleName = "bang_blood" ECLAT DE SANG lourd
--             -- local particleName = "blood_chopper" TRACE DE PAS
--             -- local particleName = "blood_entry_head_sniper" ECLAT de sang MOYEN
--             -- local particleName = "td_blood_hatchet_back" -- sang en continue leger
--             local particleName = "ent_sht_blood" --[[sang en continue lourd]]
--             -- local particleName = "blood_mist_prop" trace de sang pied
--             -- local particleName = "td_blood_melee_blunt"
...
--             StartNetworkedParticleFxNonLoopedOnPedBone(particleName, ped, 0.05, -0.0000, 0.0000, 0.0, 180.0, 0.0, bone, 0.2, false, false, false)
--     end
-- end)



-- RegisterCommand("spp", function()
--     -- for i = 0, 255 do
...
-- newPolice.CrimeScene_wCoordsDef = {{}}

-- newPolice.GetEn_insideCrimeScene = function(s)
--     isEn_wInsideSceneCrime = false
--     if newPolice.CrimeScene_wCoordsDef[1][1] ~= nil then
--     for i = 1, #newPolice.CrimeScene_wCoordsDef do
--         local CrimeScene_isDef = newPolice.CrimeScene_wCoordsDef[i]
--         local CrimeScene_isDefAll_sel = #CrimeScene_isDef
--         for i = 1, #CrimeScene_isDef do
--             if (CrimeScene_isDef[i][2] < s.y and CrimeScene_isDef[CrimeScene_isDefAll_sel][2] >= s.y or CrimeScene_isDef[CrimeScene_isDefAll_sel][2] < s.y and CrimeScene_isDef[i][2] >= s.y) then
--                 if (CrimeScene_isDef[i][1] + ( s[2] - CrimeScene_isDef[i][2] ) / (CrimeScene_isDef[CrimeScene_isDefAll_sel][2] - CrimeScene_isDef[i][2]) * (CrimeScene_isDef[CrimeScene_isDefAll_sel][1] - CrimeScene_isDef[i][1]) < s.x ) then
--                     isEn_wInsideSceneCrime = not isEn_wInsideSceneCrime
--                 end
--             end CrimeScene_isDefAll_sel = i
--         end end end
-- return isEn_wInsideSceneCrime end